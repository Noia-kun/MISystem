...
@section('title', 'Sister Dashboard')
...
<style>
    ...
    .btn-refresh:hover { background: var(--gold-light); color: var(--navy); transform: translateY(-1px); }
    ...
    .stat-card:hover { transform: translateY(-3px); box-shadow: 0 6px 22px rgba(10,22,40,0.11); }
    ...
    .quick-action-btn-primary:hover { background: var(--navy); color: var(--gold); transform: translateY(-1px); }
    ...
    .quick-action-btn-secondary:hover { border-color: var(--gold); color: var(--gold); transform: translateY(-1px); }
...
<div class="row stats-row">
    ...
    <div class="col-xl mb-3">
        <div class="stat-card">
            <div class="stat-card-body">
                <div class="stat-info">
                    <h6 style="color: #117a8b;"><i class="fa fa-screwdriver-wrench me-1"></i> INVENTORY</h6>
                    <p class="stat-number" style="color: #117a8b;">{{ $totalInventory ?? 0 }}</p>
                </div>
                <div class="stat-icon" style="background: rgba(17,122,139,0.1); color: #117a8b;">
            ...
            <div class="dash-card-body">
                <div class="quick-actions">
                    <a href="{{ url('/admin-leave-requests') }}" class="quick-action-btn quick-action-btn-primary">
                        <i class="fa fa-file-alt"></i> View Leave Requests
                    ...
                    <a href="{{ url('/admin-inventory') }}" class="quick-action-btn quick-action-btn-secondary">
                        <i class="fa fa-screwdriver-wrench"></i> View Inventory
                    </a>
