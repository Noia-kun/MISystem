                            ...
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('roomscheduler.destroy', $schedule->id) }}" method="POST" style="display:inline-block" onsubmit="return confirm('Are you sure you want to remove this schedule?');">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit" class="action-btn delete" title="Remove"><i class="fas fa-trash"></i></button>
                                    </form>
                                </td>
                            </tr>
                        @endforeach
            ...
            <div class="modal-content">
                <form action="{{ route('roomscheduler.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <!-- Time From / Time To (Now at the top) -->
                        <div class="row">
                        ...
                        <!-- Select Room(s) - Multi-select dropdown -->
                        <div class="mb-3">
                            <label class="form-label">Select Room(s) <span class="text-danger">*</span></label>
                            <div class="dropdown-multiselect">
                                <div class="dropdown-toggle" id="roomDropdown" data-bs-toggle="dropdown" aria-expanded="false">
