...
<style>
    ...
    .dash-card-header.gold  { background: linear-gradient(90deg, #b8860b, var(--gold-light)); color: var(--navy); }
...
<div class="page-header">
    <div>
        <h2 class="page-header-title">
            <i class="fa fa-calendar-days"></i> Room Reservations
        </h2>
        <p class="page-header-sub">View pending and approved room bookings, and request room schedules</p>
    </div>
    <a href="#" class="btn-header gold" data-bs-toggle="modal" data-bs-target="#addRoomModal">
        <i class="fa fa-plus"></i> Request Room Schedule
    </a>
</div>
...
<div class="dash-card shadow mb-4">    
    <div class="dash-card-header gold">
        <i class="fa fa-clock"></i> Pending Room Requests
    </div>
...
<!-- Approved Room Bookings -->
    <div class="dash-card shadow mb-4">
        <div class="dash-card-header green">
            <i class="fa fa-check-circle"></i> Approved Room Bookings
        </div>
        <div class="dash-card-body">
                        ...
                        <tbody>
                            @foreach($roomSchedules as $schedule)
                                ...
                                <tr>
                                    ...
                                    <td><span class="status-badge {{ $roomStatus === 'In Use' ? 'status-disapproved' : 'status-pending' }}">
                                        {{ $roomStatus }}
                                    </span></td>
                                </tr>
                            @endforeach
    ...
    <div class="modal fade" id="addRoomModal" tabindex="-1" aria-labelledby="addRoomModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="{{ route('public.roomscheduler.store') }}" method="POST">
                    @csrf
