...
<head>
    ...
    <title>@yield('title', 'Principal Dashboard')</title>
...
<!-- Sidebar - Principal Version (no Inventory link) -->
<div class="sidebar collapsed d-flex flex-column justify-content-between">
    <div>
        <div class="brand">
            ...
            <span class="label">Principal Portal</span>
        </div>
        <a href="{{ url('/admin-dashboard2') }}">
        ...
        {{-- NOTE: Inventory link intentionally omitted for Principal --}}
    </div>
